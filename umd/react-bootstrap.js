...
var Message = (_temp = _class = function (_React$Component) {
    ...
    Message.prototype.render = function render() {
        ...
        var iconClassName = "qiaozui_icon_success";
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "div",
            { className: "qiaozui_messae_box", style: style },
    ...
    Icon.prototype.getIconClassName = function getIconClassName() {
        switch (this.props.type) {
            ...
            case Icon.type.selected:
                return "qiaozui_icon_selected";
            case Icon.type.dropdown:
                return "qiaozui_icon_dropdown";
            case Icon.type.search:
                return "qiaozui_icon_search";
            case Icon.type.date:
                return "qiaozui_icon_date";
            case Icon.type.shanchu:
                return "icon_shanchu";
            case Icon.type.jiantouxia:
                return "qiaozui_icon_jiantou_xia";
            case Icon.type.arrowDown:
                return "qiaozui_iconfont icon_arrow_down";
            case Icon.type.arrowUp:
                return "qiaozui_iconfont icon_arrow_up";
            case Icon.type.arrowDownSimplest:
                return "qiaozui_iconfont icon_arrow_down_simplest";
            case Icon.type.arrowUpSimplest:
                return "qiaozui_iconfont icon_arrow_up_simplest";
            case Icon.type.arrowDownSmall:
                return "qiaozui_iconfont icon_arrow_down_small";
            case Icon.type.arrowUpSmall:
                return "qiaozui_iconfont icon_arrow_up_small";
            case Icon.type.add:
                return "qiaozui_iconfont icon_add";
            case Icon.type.fahuo:
                return "qiaozui_iconfont icon_fahuo";
            case Icon.type.shenhe:
                return "qiaozui_iconfont icon_shenhe";
            case Icon.type.details:
                return "qiaozui_iconfont icon_details";
            case Icon.type.synch:
                return "qiaozui_iconfont icon_synch";
            case Icon.type.message:
                return "qiaozui_iconfont icon_message";
            case Icon.type.treeCollapse:
                return "qiaozui_iconfont icon_tree_collapse";
            case Icon.type.treeExpand:
                return "qiaozui_iconfont icon_tree_expand";
            case Icon.type.moveWarehousePosition:
                return "qiaozui_iconfont icon_move_warehouse_position";
            case Icon.type.moveDown:
                return "qiaozui_iconfont icon_move_down";
            case Icon.type.moveDownmost:
                return "qiaozui_iconfont icon_move_downmost";
            case Icon.type.moveUp:
                return "qiaozui_iconfont icon_move_up";
            case Icon.type.moveUppermost:
                return "qiaozui_iconfont icon_move_uppermost";
            case Icon.type.on:
                return "qiaozui_iconfont icon_on";
            case Icon.type.off:
                return "qiaozui_iconfont icon_off";
            case Icon.type.close:
                return "qiaozui_iconfont icon_close";
            case Icon.type.account:
                return "qiaozui_iconfont icon_account";
            case Icon.type.bill:
                return "qiaozui_iconfont icon_bill";
            default:
                return "";
        }
